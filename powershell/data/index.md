...
title: "Handle PowerShell data"
description: "Handle, Import, Export, Filter and RegEx query objects"
dg-publish: true
...
- [RegEx Input Parsing - Import data out of plaintext using regular expressions](../../content/RegEx-Input-Parsing.md)
...
- [Export to files like plaintext, CSV tables, JSON object, or encrypted binaries](../../content/Export-to-files-like-plaintext-CSV-tables-JSON-object-or-encrypted-binaries.md)
