...
![table counter rownum 1.svg](./content/attachments/table%20counter%20rownum%201.svg)
...
\includegraphics{table counter rownum 2}
\end{document}
```
...
![table counter absolute.svg](./content/attachments/table%20counter%20absolute.svg)
...
![table counter absolute, body.svg](./content/attachments/table%20counter%20absolute,%20body.svg)

```latex
\documentclass{standalone} \usepackage{graphicx}
\begin{document}
\includegraphics{table counter absolute} \hspace{1em}
...
\UseTblrLibrary{functional}
\renewcommand{\thetable}{4.2\alph{table}} \setcounter{table}{1}
\IgnoreSpacesOn
\newcounter{colindex}
\newcounter{rowindex}
\intNew\nindex
...
![table counter skip.svg](./content/attachments/table%20counter%20skip.svg)
...
![table counter skip, groups.svg](./content/attachments/table%20counter%20skip,%20groups.svg)

```latex
\documentclass{standalone} \usepackage{graphicx}
\begin{document}
\includegraphics{table counter skip} \hspace{1em}
...
\usepackage{tabularray}
\UseTblrLibrary{counter}
\renewcommand{\thetable}{4.3\alph{table}} \setcounter{table}{1}
\newcounter{rowindex}
\newcounter{colindex}
\begin{document}
...
![table counters.svg](./content/attachments/table%20counters.svg)
