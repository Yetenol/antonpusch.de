...
- [Regular Expressions - Search, extract and manipulate text in a specified pattern](./regular-expressions.md)
...
- [Code aesthetics and refactoring](./code-aesthetics%20and%20refactoring.md)
- [Git - Track changes, collaborate, and backup](./git.md)
- [Unicode characters - Push files to the top of bottom of the list in alphabetical sorting](./unicode-characters.md)
