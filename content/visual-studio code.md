...
| ------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------- | -------------------------------------------------------------------------------------------------------------------------- |
| **[C, C++](./c-c++.md)**                                                 |                                                                                                                                                                       | [Extensions](vscode:extension/ms-vscode.cpptools), [Web Marketplace](https://marketplace.visualstudio.com/items?itemName=ms-vscode.cpptools)                                       | \-              | C/C++ IntelliSense, debugging, and code browsing.                                                                          |
| **[CMake Tools](./cmake-tools.md)**                                       |                                                                                                                                                                       | [Extensions](vscode:extension/ms-vscode.cmake-tools), [Web Marketplace](https://marketplace.visualstudio.com/items?itemName=ms-vscode.cmake-tools)                                 | \-              | Compile C projects using cmake                                                                                             |
| **[Change Case](./change-case.md)**                                       | ![](https://cdn.vsassets.io/v/M226_20230814.3/_content/Header/default_icon_128.png)                                                                                   | [Extensions](vscode:extension/FinnTenzor.change-case), [Web Marketplace](https://marketplace.visualstudio.com/items?itemName=FinnTenzor.change-case)                               | \-              | Quickly change the case with one keybinding                                                                                |
...
- [Develop AutoHotkey - Program, compile, debug in VS Code](./develop-autohotkey.md)
- [Obsidian as a markdown editor - Switch between Vscode and Obsidian](./obsidian-as%20a%20markdown%20editor.md)
...
- [Invoke a shell command in VS Code's integrated terminal using a keybindung](./invoke-a%20shell%20command%20in%20vs%20code's%20integrated%20terminal%20using%20a%20keybindung.md)
