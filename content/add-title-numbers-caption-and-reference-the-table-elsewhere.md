...
- See [Layout the table](./layout-the-table.md) for clickable, colored links
...
- See [Layout the table](./layout-the-table.md) to set default placement specifiers
```latex
See table \ref{tab:identifiers} for details.
\begin{table}[hbp]
...
Demos with tex, text cells, and hlines styles from [Create a simple table with borders](./create-a-simple-table-with-borders.md) as default:
