...
date: "2025-01-02T00:00:00.000+01:00"
dg-publish: true
---
...
- pageTitle, pageTitleSuffix, baseUrl
- disable Plugin.TagPage(),

Layout

- disable     // Component.Breadcrumbs(),
- disable     // Component.Graph(),
- disable     // Component.DesktopOnly(Component.Explorer()),
...
- Change [Execute Code](./execute-code.md)'s executable codeblocks to their regular language for syntax highlighting
- Replace [Dynamic Embed](./dynamic-embed.md)'s blocks with the note's content. Use to following regex pattern and replace the note name
