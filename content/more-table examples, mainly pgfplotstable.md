...
- [Add title numbers, caption, and reference the table elsewhere](./add-title%20numbers,%20caption,%20and%20reference%20the%20table%20elsewhere.md) 
- [Create a simple table with borders](./create-a%20simple%20table%20with%20borders.md)
...
- See source examples: [Create a simple table with borders](./create-a%20simple%20table%20with%20borders.md)

![minimal 45.svg](./attachments/minimal-45.svg)
...
![simple table.svg](./attachments/simple-table.svg)![csv alternate table.svg](./attachments/csv-alternate%20table.svg)
![minimal 2.svg](./attachments/minimal-2.svg)

# Examples

- import the file [yetenol-styles.sty](more-table%20examples,%20mainly%20pgfplotstable.md#Styling%20setup) for the required style definitions
...
![minimal 5.svg](./attachments/minimal-5.svg)
...
![simple table.svg](./attachments/simple-table.svg)

Generate a table from a **csv**-spreadsheet (comma separated values)
- requires [resources/data.csv](more-table%20examples,%20mainly%20pgfplotstable.md#Example%20files)
...
![minimal 14.svg](./attachments/minimal-14.svg)

Generate a table from a **csv** [file](more-table%20examples,%20mainly%20pgfplotstable.md#Example%20files) and **color** every other row
...
![csv alternate table.svg](./attachments/csv-alternate%20table.svg)
...
![minimal 9.svg](./attachments/minimal-9.svg)
...
![minimal 11.svg](./attachments/minimal-11.svg)
...
![longtable combined.svg](./attachments/longtable-combined.svg)
...
![caption label table.svg](./attachments/caption-label%20table.svg)
...
![german scisepalign table.svg](./attachments/german-scisepalign%20table.svg)
...
![minimal 1.svg](./attachments/minimal-1.svg)
...
![minimal 3.svg](./attachments/minimal-3.svg)
...
![minimal 4.svg](./attachments/minimal-4.svg)
