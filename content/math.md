...
\end{align*}
$$
- See examples with source code: [Showcase of math equations](./showcase-of%20math%20equations.md)
...
- See examples with source code: [Array-like environments - Align equations and relation symbol relative to each other](./array-like%20environments.md)
...
- See examples with source code: [LaTeX Symbols - Lookup mathematical symbols, operations, relations, and arrows](./latex-symbols.md)
...
- See examples with source code: [Wrap long equation over multiple lines](./wrap-long%20equation%20over%20multiple%20lines.md)
...
- See examples with source code: [Comment equation operators](./comment-equation%20operators.md)
...
- See examples with source code: [Follow varying typographic conventions with the same input syntax](./follow-varying%20typographic%20conventions%20with%20the%20same%20input%20syntax.md)
...
- See examples with source code: [Simple commutative diagrams supported by KaTeX, MathJaX - Amscd](Simple%20commutative%20diagrams%20supported%20by%20KaTeX,%20MathJaX%20-%20Amscd.md)
- See more complex examples: [Networks, Commutative diagrams - Dynamically draw graph networks as a vector graphic](./networks-commutative%20diagrams.md)
...
- new operator [Mathematical Typesetting with Latex 0.34 2024-02-06, page 41](./attachments/mathematical-typesetting%20with%20latex%200.34%202024-02-06.pdf.md#page=41&selection=259,7,259,18)
