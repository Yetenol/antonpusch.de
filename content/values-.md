...
- [Currencies and money -  Standardize monetary values, 3 € vs $ 5](./currencies-and%20money.md)
- [Numeric values - Typeset (large) numbers, physical quantities, units, money](./numeric-values.md)
- [Define custom mathematical expressions](./define-custom%20mathematical%20expressions.md)
