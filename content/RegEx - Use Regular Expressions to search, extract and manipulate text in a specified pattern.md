...
| ----------- | -------------------------------------------------------------------------- |
| `\p{ctgry}` | In that [Unicode Category](RegEx%2520-%2520Use%2520Regular%2520Expressions%2520to%2520search,%2520extract%2520and%2520manipulate%2520text%2520in%2520a%2520specified%2520pattern.md##Supported%2520Unicode%2520Categories) or block     |
| `\P{ctgry}` | Not in that [Unicode Category](RegEx%2520-%2520Use%2520Regular%2520Expressions%2520to%2520search,%2520extract%2520and%2520manipulate%2520text%2520in%2520a%2520specified%2520pattern.md##Supported%2520Unicode%2520Categories) or block |
| `\w`        | Word character                                                             |
