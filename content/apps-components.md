---
title: "Apps, Components - Access certificates, calculator, task scheduler"
...
- `devmgmt.msc` or `hdwwiz.cpl` Device Manager
...
- `devmgmt.msc` or<br> `hdwwiz.cpl` Device Manager
...
- `devicepairingwizard` **Add a device (wizard)**
