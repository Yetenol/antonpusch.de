...
- See [Layout the table](./layout-the%20table.md) for clickable, colored links
...
- See [Layout the table](./layout-the%20table.md) to set default placement specifiers
```latex
See table \ref{tab:identifiers} for details.
\begin{table}[hbp]
...
Demos with tex, text cells, and hlines styles from [Create a simple table with borders](./create-a%20simple%20table%20with%20borders.md) as default:
![minimal 52.svg](./attachments/minimal-52.svg)
