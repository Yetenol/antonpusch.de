...
![table body macros.svg](./attachments/table-body%20macros.svg)
...
![table body monospace.svg](./attachments/table-body%20monospace.svg)
...
![table text color.svg](./attachments/table-text%20color.svg)
...
![table text hyperlinks.svg](./attachments/table-text%20hyperlinks.svg)

![table text hyperlinks.pdf](./attachments/table-text%20hyperlinks.pdf)
