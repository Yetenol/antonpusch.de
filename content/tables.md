...
![table text formatting.svg](./attachments/table-text%20formatting.svg)
...
![table accumulate trip expenses.svg](./attachments/table-accumulate%20trip%20expenses.svg)

## Process files

- See examples with source code: [CSV Input - Dynamically generate table from file](./csv-input.md)

![table file input.svg](./attachments/table-file%20input.svg)
...
-  See examples with source code: [Calculate statistics for table numbers](./calculate-statistics%20for%20table%20numbers.md)
...
- See examples with source code: [Process, and format values from files](./process-and%20format%20values%20from%20files.md)

![table measurements 1.svg](./attachments/table-measurements%201.svg)
...
- See examples with source code: [Layout the table](./layout-the%20table.md)

![table layout 1.svg](./attachments/table-layout%201.svg)



# Export formatted table

![table body macro column.svg](./attachments/table-body%20macro%20column.svg)
...
- [More table examples, mainly pgfplotstable](./more-table%20examples,%20mainly%20pgfplotstable.md)
