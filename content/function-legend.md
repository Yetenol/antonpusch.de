...
![plot legend outside.svg](./attachments/plot-legend-outside.svg)
...
![plot legend next to line.svg](./attachments/plot-legend-next-to-line.svg)
...
plt.savefig(@vault_path + '/attachments/plot legend next to line.svg')
plt.show()
```
...
graph_example_function(ax)
annotate_lines(ax)
plt.savefig(@vault_path + '/attachments/plot legend at line.svg')
plt.show()
```
