---
title: "Curl - Download or invoke files, ZIP containers from the internet"
dg-publish: true
priority: 4
---
...
- _Downloads_ is a [user-specific folder](./user%20folders.md)
...
- _Temp_ is a [common-user folder](./user%20folders.md)
- Aborts on failure.
