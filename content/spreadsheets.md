...
\begin{tblr}[tall,caption={Calculate bold trip expenses, distances},note{}={
    ...
    \cellCopy{r={2-Z},c={4},accum={\lTmpcFp != 0 ? min(\lTmpaFp,\lTmpcFp) : \lTmpaFp},initial={999999}}\,€} 
    to \textbf{%
    \cellCopy{r={2-Z},c={4},accum={max(\lTmpaFp,\lTmpcFp)}, initial={-999999}}\,€}. 
    In total, accommodation costs \textbf{%
    \cellCopy{r={2-Z},c={6},accum={\lTmpaFp + \lTmpcFp}}\,€}
    averaging \textbf{%
    \fpEval{ round(
    \cellCopy{r={2-Z},c={6},accum={\lTmpaFp + \lTmpcFp}} /
    \cellCopy{r={2-Z},c={6},accum={\lTmpaFp + 1}}, 2) }\,€}
    per night.},
]{
