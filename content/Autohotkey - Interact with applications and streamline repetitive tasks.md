...
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- |
| **AutoHotkey**<div>[Website](https://www.autohotkey.com/download/ahk-v2.exe) </div><div><button class='copy-winget-button' onclick="navigator.clipboard.writeText('winget install -e AutoHotkey.AutoHotkey --scope machine')">AutoHotkey.AutoHotkey📋</button></div><div class='category-tag'>[Development](Install%20Development%20apps.md)</div> | A scripting language to create hotkeys, interact with applications, manipulate windows, automate ... [more details](./AutoHotkey.md) |
