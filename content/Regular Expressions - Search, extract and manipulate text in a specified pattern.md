...
| ----------- | -------------------------------------------------------------------------- |
| `\p{ctgry}` | In that [Unicode Category](Regular%2520Expressions%2520-%2520Search,%2520extract%2520and%2520manipulate%2520text%2520in%2520a%2520specified%2520pattern.md##Supported%2520Unicode%2520Categories) or block     |
| `\P{ctgry}` | Not in that [Unicode Category](Regular%2520Expressions%2520-%2520Search,%2520extract%2520and%2520manipulate%2520text%2520in%2520a%2520specified%2520pattern.md##Supported%2520Unicode%2520Categories) or block |
| `\w`        | Word character                                                             |
