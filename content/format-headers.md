...
![table pet owners.svg](./attachments/table-pet%20owners.svg)
...
![table comparison 1.svg](./attachments/table-comparison%201.svg)
...
- To dynamically calculate the sum, see [Calculate statistics for table numbers](./calculate-statistics%20for%20table%20numbers.md)

![table probabilities 1.svg](./attachments/table-probabilities%201.svg)
...
![table headers rotated.svg](./attachments/table-headers%20rotated.svg)
...
![table headers pgfplotstable.svg](./attachments/table-headers%20pgfplotstable.svg)
