...
- [Bash Equivalents - Replace code from Linux Bash with PowerShell equivalents](./bash%20equivalents.md)
...
- [Application Updates - Bulk upgrade applications from Microsoft Store, winget, or git](./application%20updates.md)
