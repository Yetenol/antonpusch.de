...
- Download the [latest release](https://github.com/artisticat1/obsidian-latex-suite/releases/latest) from [Github](https://github.com/artisticat1/obsidian-latex-suite)  
