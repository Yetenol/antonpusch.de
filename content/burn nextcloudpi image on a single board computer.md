---
title: "Burn NextcloudPi image on a single board computer"
dg-publish: true
priority: 1
---
...
Enable local network HTTP connection to [NextcloudPi Configuration Web Panel](NextcloudPi%20Configuration%20Web%20Panel.md)
- Run `sudo ncp-config`
...
- Open `ssh anton@plutoscloud.local` on your computer and login using your Raspberry Pi credential to access [NextcloudPi Shell](NextcloudPi%20Shell.md) 
- Open https://10.0.0.2:4333 in your computers web browser to access [NextcloudPi Configuration Web Panel](NextcloudPi%20Configuration%20Web%20Panel.md)
