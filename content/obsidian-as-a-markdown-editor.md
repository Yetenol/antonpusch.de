...
- requires [Shell commands](./shell-commands.md)
...
- requires [Terminal Command Keys](./terminal-command-keys.md) and [Advanced URI](./advanced-uri.md)
...
- requires [Terminal Command Keys](./terminal-command-keys.md)
