...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------- | ---------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **[Text Snippets](./text-snippets.md)**                                                                                                                 |           | [Comminity plugins](obsidian://show-plugin?id=text-snippets-obsidian), [Webstore](https://obsidian.md/plugins?id=text-snippets-obsidian) | Editing                                  | Snippets for faster typing. Allows you to replace text templates, create your own, and expand text shortcuts.                                                                                            |
...
| **[Remotely Save](./remotely-save.md)**                                                                                                                 |           | [Comminity plugins](obsidian://show-plugin?id=remotely-save), [Webstore](https://obsidian.md/plugins?id=remotely-save)                   | Synchronization                          | Yet another unofficial plugin allowing users to sync notes between local device and the cloud service (S3, Dropbox, webdav, OneDrive).                                                                   |
| **[Digital Garden](./digital-garden.md)**                                                                                                               |           | [Comminity plugins](obsidian://show-plugin?id=digitalgarden), [Webstore](https://obsidian.md/plugins?id=digitalgarden)                   | Publishing                               | Publish your notes to a digital garden for others to enjoy.                                                                                                                                              |
| **[Obsidian Git](./obsidian-git.md)**                                                                                                                   |           | [Comminity plugins](obsidian://show-plugin?id=obsidian-git), [Webstore](https://obsidian.md/plugins?id=obsidian-git)                     | Synchronization, Version control, Backup | Plugin that allows you to back up your Obsidian.md vault to a remote Git repository (e.g. private repo on GitHub).                                                                                       |
...
| **[Copy as Latex](./copy-as-latex.md)**                                                                                                                 |           | [Comminity plugins](obsidian://show-plugin?id=obsidian-copy-as-latex), [Webstore](https://obsidian.md/plugins?id=obsidian-copy-as-latex) | \-                                       | Designed for when you want to do most of your writing in a nice Obsidian environment, with lots of citations from a nicely managed set of references etc. Lighterweight than Pandoc, doesn't assume y... |
| **[Advanced Cursors](./advanced-cursors.md)**                                                                                                           |           | [Comminity plugins](obsidian://show-plugin?id=advanced-cursors), [Webstore](https://obsidian.md/plugins?id=advanced-cursors)             | Editing                                  | Use multiple cursors even more powerfully.                                                                                                                                                               |
| **[LaTeX Suite](./latex-suite.md)**                                                                                                                     |           | [Comminity plugins](obsidian://show-plugin?id=obsidian-latex-suite), [Webstore](https://obsidian.md/plugins?id=obsidian-latex-suite)     | Editing, Math                            | A plugin for Obsidian that aims to make typesetting LaTeX math as fast as handwriting.                                                                                                                   |
...
| **[Execute Code](./execute-code.md)**                                                                                                                   |           | [Comminity plugins](obsidian://show-plugin?id=execute-code), [Webstore](https://obsidian.md/plugins?id=execute-code)                     | Programming                              | Execute code snippets within a note.                                                                                                                                                                     |
| **[Advanced URI](./advanced-uri.md)**                                                                                                                   |           | [Comminity plugins](obsidian://show-plugin?id=obsidian-advanced-uri), [Webstore](https://obsidian.md/plugins?id=obsidian-advanced-uri)   | Programming                              | Control everything with URI.                                                                                                                                                                             |
| **[Shell commands](./shell-commands.md)**                                                                                                               |           | [Comminity plugins](obsidian://show-plugin?id=obsidian-shellcommands), [Webstore](https://obsidian.md/plugins?id=obsidian-shellcommands) | Programming                              | Define system commands that you want to execute via command palette, hotkeys, URI links or automated events. E.g. open external applications or perform automated file modifications.                    |
| **[Dynamic Embed](./dynamic-embed.md)**                                                                                                                 |           | [Comminity plugins](obsidian://show-plugin?id=obsidian-dynamic-embed), [Webstore](https://obsidian.md/plugins?id=obsidian-dynamic-embed) | Visualisation                            | Embed snippets, templates and any linkable by delegating the current scope to the embedded file, treating it as content instead of a reference.                                                          |
...
| **[Code Emitter](./code-emitter.md)** ⊘ Discarded                                                                                                       |           | [Comminity plugins](obsidian://show-plugin?id=code-emitter), [Webstore](https://obsidian.md/plugins?id=code-emitter)                     | Programming                              | Allows code blocks to be executed interactively in a sandbox like Jupyter notebooks. Supported language Rust, Kotlin, Python, JavaScript, TypeScript, etc.                                               |
| **[Self-hosted LiveSync](./self-hosted-livesync.md)** ⊘ Discarded                                                                                       |           | [Comminity plugins](obsidian://show-plugin?id=obsidian-livesync), [Webstore](https://obsidian.md/plugins?id=obsidian-livesync)           | Synchronization                          | Community implementation of self-hosted livesync. Reflect your vault changes to some other devices immediately. Please make sure to disable other synchronize solutions to avoid content corruption o... |
...
![Pasted image 20231204121250.png](./attachments/pasted-image-20231204121250.png)
...
- [Obsidian as a markdown editor - Switch between Vscode and Obsidian](./obsidian-as-a-markdown-editor.md)
...
- [Hide the first-level bullet points from results of list queries](./hide-the-first-level-bullet-points-from-results-of-list-queries.md)
- [Create diagrams](Create%20diagrams.md)
- [Convert wikilinks to markdown links](./convert-wikilinks-to-markdown-links.md)
