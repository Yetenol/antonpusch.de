...
- [Learn and Troubleshoot Powershell  - Discover commands, and access documentation](./Learn%20and%20Troubleshoot%20Powershell%20%20-%20Discover%20commands,%20and%20access%20documentation.md)  
...
- [Naming Convention - Name PowerShell functions with one of the predefined verbs](./Naming%20Convention%20-%20Name%20PowerShell%20functions%20with%20one%20of%20the%20predefined%20verbs.md)  
- [Manage schedules tasks](Manage%20schedules%20tasks.md)  
- [Command Prompt Comparison - PowerShell vs CMD](Command%20Prompt%20Comparison%20-%20PowerShell%20vs%20CMD.md)  
- [Bash Equivalents - Replace code from Linux Bash with PowerShell equivalents](./Bash%20Equivalents%20-%20Replace%20code%20from%20Linux%20Bash%20with%20PowerShell%20equivalents.md)  
- [Bash Comparison - Powershell Core vs Bash](Bash%20Comparison%20-%20Powershell%20Core%20vs%20Bash.md)  
- [Automate tasks using a shell or an external application](Automate%20tasks%20using%20a%20shell%20or%20an%20external%20application.md)  
- [Application Updates - Bulk upgrade applications from Microsoft Store, winget, or git](./Application%20Updates%20-%20Bulk%20upgrade%20applications%20from%20Microsoft%20Store,%20winget,%20or%20git.md)  
