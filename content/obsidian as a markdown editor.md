---
title: "Obsidian as a markdown editor - Switch between Vscode and Obsidian"
dg-publish: true
---
...
- requires [Shell commands](./shell%20commands.md)
...
- requires [Terminal Command Keys](./terminal%20command%20keys.md) and [Advanced URI](./advanced%20uri.md)
...
> [!warning] Ignore the folder `external/` in git and in [Remotely Save](./remotely%20save.md)
...
- requires [Terminal Command Keys](./terminal%20command%20keys.md)
