...
| ----------- | -------------------------------------------------------------------------- |
| `\p{ctgry}` | In that [Unicode Category](regular-expressions.md##Supported%2520Unicode%2520Categories) or block     |
| `\P{ctgry}` | Not in that [Unicode Category](regular-expressions.md##Supported%2520Unicode%2520Categories) or block |
| `\w`        | Word character                                                             |
