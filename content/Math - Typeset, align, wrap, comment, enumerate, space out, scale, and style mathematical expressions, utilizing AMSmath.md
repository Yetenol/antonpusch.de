...
\end{align*}
$$
- See examples with source code: [Showcase of math equations](./Showcase%20of%20math%20equations.md)
...
- See examples with source code: [Array-like environments - Align equations and relation symbol relative to each other](./Array-like%20environments%20-%20Align%20equations%20and%20relation%20symbol%20relative%20to%20each%20other.md)
...
- See examples with source code: [LaTeX Symbols - Lookup mathematical symbols, operations, relations, and arrows](./LaTeX%20Symbols%20-%20Lookup%20mathematical%20symbols,%20operations,%20relations,%20and%20arrows.md)
...
- See examples with source code: [Wrap long equation over multiple lines](./Wrap%20long%20equation%20over%20multiple%20lines.md)
...
- See examples with source code: [Comment equation operators](./Comment%20equation%20operators.md)
...
- See examples with source code: [Follow varying typographic conventions with the same input syntax](./Follow%20varying%20typographic%20conventions%20with%20the%20same%20input%20syntax.md)
...
- [OfficeMath - Create mathematical equations and expressions in Microsoft Office products](./OfficeMath%20-%20Create%20mathematical%20equations%20and%20expressions%20in%20Microsoft%20Office%20products.md)

Typst Math
- [Math – Typst Documentation](https://typst.app/docs/reference/math/)
- [TYPST - A modern, readable, robust, fast typesetting system](./TYPST%20-%20A%20modern,%20readable,%20robust,%20fast%20typesetting%20system.md)
