...
- See source examples: [Layout the table](./layout-the%20table.md)
...
![table stats integer sum.svg](./attachments/table-stats%20integer%20sum.svg)
...
![table stats float sum.svg](./attachments/table-stats%20float%20sum.svg)
