...
priority: 
link-modportals: 
modportal0-id: trentrand.git-rebase-shortcuts
thumbnail: https://trentrand.gallerycdn.vsassets.io/extensions/trentrand/git-rebase-shortcuts/1.1.0/1613430968103/Microsoft.VisualStudio.Services.Icons.Default
categories:
  - Version control
synopsis: Use keyboard shortcuts to quickly edit the actions of an interactive Git rebase.
extends-app: "[[Visual Studio Code|Visual Studio Code]]"
---

![thumbnail](https://trentrand.gallerycdn.vsassets.io/extensions/trentrand/git-rebase-shortcuts/1.1.0/1613430968103/Microsoft.VisualStudio.Services.Icons.Default) Git rebase shortcut is a [Visual Studio Code](./visual%20studio%20code.md) extension about version control. Use keyboard shortcuts to quickly edit the actions of an interactive Git rebase.
