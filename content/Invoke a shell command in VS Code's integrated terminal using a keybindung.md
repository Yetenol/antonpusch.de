...
Add a custom key binding to invoke a certain shell command. Requires the extension [Terminal Command Keys](./Terminal%20Command%20Keys.md)  
...
[Terminal Command Keys](./Terminal%20Command%20Keys.md)