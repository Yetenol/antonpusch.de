---
title: "Table with Equal Width Columns - Typeset tables with distributed column width"
dg-publish: true
priority: 5
---
...
- `⟨placement specifiers⟩` := see [Positioning](table%2520with%2520equal%2520width%2520columns.md##positioning)
