...
- [Invoke a shell command in VS Code's integrated terminal using a keybindung](./invoke-a-shell-command-in-vs-code-s-integrated-terminal-using-a-keybindung.md)
