---
title: "Flüge für die Georgienreise"
dg-publish: true
dg-show-toc: true
---

Wir suchen Hin- und Rückflüge für den Zeitraum 30. Juli bis 15. August.

# Hinflug

## Route und Tag

Welche Start- und Zielflughäfen sind günstig? Welcher Anreisetag ist günstig? 
Vergleich des ungefähren billigsten Preises für 4 Erwachsene laut *Google Flights*:

| Route⁽¹⁾    | So, 30.7. | Mo, 31.7. | Di, 01.8. | Mi, 02.8. |
| ----------- | ---------:| ---------:| ---------:| ---------:|
...
Welche Verbindungen ergeben sich konkret daraus? Welche Fluggesellschaft fliegt? 
Vergleich der Reiseverbindungen mit Links zu Buchungsportalen:
...
Welche Start- und Zielflughäfen sind günstig? Welcher Abreisetag ist günstig?
Vergleich des ungefähren billigsten Preises für 4 Erwachsene laut *Google Flights*:
...
# Kombinationen aus Hin- und Rückflug

Lässt sich die gleiche Fluggesellschaft nutzen? Wie lange ist der Urlaubsaufenthalt?
Vergleich von Kombinationen aus Hin- und Rückflug:
...
## ⁽¹⁾ Potentielle Flughäfen

Flughäfen werden mit einem dreistelligen IATA-Flughafencode identifiziert:
...
Die Flugnummern identifizieren Einzelflüge mit Link auf Buchungsportale bei *Google Flights*. Der vorangestellte IATA-Code ordnet einer Flugnummer eine Fluggesellschaft zu:
