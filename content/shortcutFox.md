...
- Invoke the [installer of the latest release](https://github.com/Yetenol/shortcutFox/releases/latest/download/shortcutFox.exe) from [Github](https://github.com/Yetenol/shortcutFox)
  ```powershell
