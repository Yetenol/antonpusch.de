...
Primitively negated symbols  
- Not recommended, use [properly negated symbols](LaTeX%2520Symbols%2520-%2520Lookup%2520mathematical%2520symbols,%2520operations,%2520relations,%2520and%2520arrows.md##negated-binary-relations-and-arrows) instead.    
- Prefix the command with `\not` like `\not\leq`.    
  
Set the **style** of the relation in the preamble  
...
| `\gets`           | $\gets$                         |            |  
| `\leftrightarrow` | $\leftrightarrow$               |            |  
| `\iff`            | $\iff$ (bigger margin)          |            |  
| `\implies`        | $\implies$ (bigger margin)      |            |  
| `\impliedby`      | ${} \impliedby$ (bigger margin) |            |  
| `\mapsto`         | $\mapsto$                       |            |  
  
| Command                        | Rendering                 | Dependency                                      |  
| ------------------------------ | ------------------------- | ----------------------------------------------- |  
| `\gets` <br> `\leftarrow` <br> | $\gets$ <br> $\leftarrow$ |                                                 |  
| `\longleftarrow`               | $\longleftarrow$          |                                                 |  
| `\to` <br> `\rightarrow` <br>  | $\to$ <br> $\rightarrow$  |                                                 |  
