...
![figure plot cycles color.svg](../figure-plot-cycles-color.svg)
...
![figure plot cycles linestyle.svg](../figure-plot-cycles-linestyle.svg)
...
![plot cycles custom linestyles.svg](../plot-cycles-custom-linestyles.svg)
...
See [graphic for print documents (PDF)](../plot-cycles.pdf) or graphic for displays:
