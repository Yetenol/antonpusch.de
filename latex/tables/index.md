---
date: "2025-03-22T10:36:38.445+01:00"
title: Tables
description: "Separate content in plaintext and styles like alignment, spacing, markup, and calculation, utilizing Tabularray"
dg-publish: true
dg-show-toc: true
aliases:
  - Table
...
![figure table text formatting.svg](../../content/figure-table-text-formatting.svg)
...
![figure table floats.svg](../../content/figure-table-floats.svg)
...
![figure table counters.svg](../../content/figure-table-counters.svg)
...
![figure table accumulate trip expenses.svg](../../content/figure-table-accumulate-trip-expenses.svg)

## Process files

- See examples with source code: [CSV Input - Dynamically generate table from file](./CSV-Input.md)

![figure table file input.svg](../../content/figure-table-file-input.svg)
...
![figure table accumulate.svg](../../content/figure-table-accumulate.svg)
...
![figure table functional.svg](../../content/figure-table-functional.svg)
...
![figure table measurements 1.svg](../../content/figure-table-measurements-1.svg)
...
![figure table layout 1.svg](../../content/figure-table-layout-1.svg)



# Export formatted table

![figure table body macro column.svg](../../content/figure-table-body-macro-column.svg)
