---
date: "2025-03-22T11:19:47.019+01:00"
...
- [Add title numbers, caption, and reference the table elsewhere](../../Add-title-numbers-caption-and-reference-the-table-elsewhere.md) 
- [Create a simple table with borders](../../Create-a-simple-table-with-borders.md)
...
- See source examples: [Create a simple table with borders](../../Create-a-simple-table-with-borders.md)
...
![simple table.svg](../../attachments/simple-table.svg)![csv alternate table.svg](../../attachments/csv-alternate-table.svg)
![minimal 2.svg](../../attachments/minimal-2.svg)

# Examples

- import the file [yetenol-styles.sty](More-table-examples-mainly-pgfplotstable.md#Styling%20setup) for the required style definitions
...
- requires [resources/data.csv](More-table-examples-mainly-pgfplotstable.md#Example%20files)
...
Generate a table from a **csv** [file](More-table-examples-mainly-pgfplotstable.md#Example%20files) and **color** every other row
...
![csv alternate table.svg](../../attachments/csv-alternate-table.svg)
...
![caption label table.svg](../../attachments/caption-label-table.svg)
...
![german scisepalign table.svg](../../attachments/german-scisepalign-table.svg)
