...
![figure table headers.svg](../content/figure-table-headers.svg)

[Code Snippets - Print source code with syntax highlighting in latex with listings](./Code-Snippets.md)

![figure code listing.svg](../content/figure-code-listing.svg)
...
- [Learn and troubleshoot LaTeX - Read (package) documentation, cheat sheets, tutorials](../content/Learn-and-troubleshoot-LaTeX.md)
- [Develop LaTeX packages](../content/Develop-LaTeX-packages.md)

Other topics

- [Values  - Standardize math, numbers, symbols, quantities, money](../content/Values-.md)
- [Float - Dynamically place figures, images, tables, and listings at the top, bottom, or single page](../content/Float.md)
- [Graphics, Plots, Visualization - Generate dynamic professional vector graphics with matching fonts, design](../content/Graphics-Plots-Visualization.md)
- [Project structure - Create folders for setup, resources, bibliographies](../content/Project-structure.md)
- [Graphical elements - Standardize tables, images, plots](../content/Graphical-elements.md)
- [Layout the document - Setup margins, hyphenation, table of contents](../content/Layout-the-document.md)
...
Tags:
[Markup and typesetting systems - Produce printed or digital documents aesthetically pleasing with readable typography](../content/Markup-and-typesetting-systems.md)
