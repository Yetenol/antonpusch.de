...
- See examples with source code: [Symbols - Lookup mathematical symbols, operations, relations, and arrows](../Symbols.md)
...
- new operator [Mathematical Typesetting with Latex 0.34 2024-02-06, page 41](../../content/Mathematical-Typesetting-with-Latex-0-34-2024-02-06.pdf.md#page=41&selection=259,7,259,18)
...
- [OfficeMath - Create mathematical equations and expressions in Microsoft Office products](../../content/OfficeMath.md)

Typst Math
- [Math – Typst Documentation](https://typst.app/docs/reference/math/)
- [TYPST - A modern, readable, robust, fast typesetting system](../../content/TYPST.md)
